...
cat $JSON_MSG | python $TEXTPY_PATH -t txt -r text -p 19,0,15,5,3,6,4,20,8 -w BROWN_STR -b $BROWNCLUSTERS_PATH -j lines | python add_misinformation_to_json.py $MODEL_PATH $TRAINING_DATA_PATH $OUTPATH
